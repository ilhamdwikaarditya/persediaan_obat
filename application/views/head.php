...
<head>
<meta charset="utf-8"/>
<title>Aplikasi Stok Obat</title>
...
<div class="page-header navbar navbar-fixed-top">
	...
	<div class="page-header-inner">
		...
		<div class="page-logo">
			...
			&nbsp;&nbsp;&nbsp;&nbsp;
			&nbsp;&nbsp;&nbsp;&nbsp;
			<img src="<?php echo base_url(); ?>assets/img/obat.png" style="width:80px" alt="logo" class="logo-default"/>
			</a>
				...
				<li class="<?php echo @($amenu['active'][0]['menu']==$menu['menu'])? "active open":""?>">
					...
					<ul class="sub-menu">	
						...
						<li class="<?php echo @($amenu['active'][1]['menu']==$submenu['menu'])? "active open":""?>">
							<a href="<?php echo @($submenu['controller'])? base_url().'index.php/'.$submenu['controller']:"javascript:;";?>">
