			<div class="page-head">
				<div class="page-title">
					<h1>Cetak Laporan Persediaan <small>Puskesmas</small></h1>
				</div>
					...
					<div class="portlet box green">
						...
						<div class="portlet-body">
							<div class="form-body form-horizontal">
								...
								<div class="row">
									<label class="col-md-3 control-label align-left">Puskesmas</label>
									<div class="col-md-4">
										<div class="input-group">
...
function cetak(){
	...
	var puskesmas = document.getElementById("id_puskesmas").value;
	
	hreF   = "<?php echo site_url("Report_puskesmas/rpt_persediaan")?>";
	ReQuest= "/" + tgl_awal + "/" + tgl_akhir + "/" + puskesmas;
