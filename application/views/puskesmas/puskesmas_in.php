			<div class="page-head">
				<div class="page-title">
					<h1>Gudang ke Puskesmas <small>masuk ke Puskesmas</small></h1>
				</div>
...
<form action="#" id="form" role="form">
							...
							<div class="note note-success">
								<h1 class="block center"><center>Puskesmas In</center></h1>
							</div>
							</br>
						</div>
					</div>
				...
				<div class="col-md-6">
					<div class="portlet light">
						<div class="portlet-body">
							<div class="form-body form-horizontal">
								<div class="form-group">
									<label class="col-md-6 control-label align-left">Nama Puskesmas</label>
									<div class="col-md-6">
										<?php echo form_dropdown("id_puskesmas",$puskesmas,'','id="id_puskesmas" style="display:none;"'); ?>
									</div>
								</div>
								<div class="form-group">
					...
					<div class="panel panel-success">
						<div class="panel-body form-horizontal">
							<div class="table-scrollable">
								<table class="table table-striped table-bordered table-hover" id="InPuskesmasTbl">
									<thead>
										<tr>
											<th>
												 NAMA PUSKESMAS
...
$(document).ready(function() {
	...
	$("#id_puskesmas").select2({ width: '100%' });
	...
	$('#cari').keyup(function(e) {
		...
		if(cari != ""){
            ...
            $.ajax({
                url: '<?php echo site_url()?>/Puskesmas/getObat',
                type: 'post',
	...
	$("#tgl_in").on("change", function(){
		...
		$('#InPuskesmasTbl').DataTable().clear().draw();
		$('#InPuskesmasTbl').DataTable({
			destroy: true,	
			"bPaginate": false,
			"bLengthChange": false,
			"bFilter": false,
			...
			"ajax": 
			{
				"url": "<?php echo site_url('Puskesmas/Obat_in_Puskesmas')?>",
				"type": 'POST',
	...
	InPuskesmasTbl = $('#InPuskesmasTbl').DataTable({ 
		destroy: true,
		"bPaginate": false,
		"bLengthChange": false,
		"bFilter": false,
...
function validasi(){
    ...
    $.ajax({
        url: '<?php echo site_url()?>/Puskesmas/saveObat',
        type: 'post',
        data: $('#form').serialize(),
        dataType: 'json',
        success: function(response){
			var batchagain = $("#batch_obat").val();
            $('#InPuskesmasTbl').DataTable().clear().draw();
			$('#InPuskesmasTbl').DataTable({
				destroy: true,	
				"bPaginate": false,
