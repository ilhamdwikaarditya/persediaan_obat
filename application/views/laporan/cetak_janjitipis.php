...
<table width=100% class="font_standar" border=0>
	...
	<tr>
		...
		<td colspan=5 align="justify">
			...
			dengan daya <b><?php echo number_format($data_agenda['DAYA_BARU']) ?></b> VA, <?php echo $data_tarif['KLMPK_PHASA'] ?>, <?php echo $data_tarif['KLMPK_TEGANGAN'] ?> dengan kualitas tegangan +5 % dan –10% , Frekuensi 50 Hz dengan kualitas frekuensi  +/- 1% Cos phi 0,85, 
			tarif  <?php echo $data_agenda['TARIF_BARU'] ?> pemakaian nyala minimum <?php echo $data_jam['NILAI_JAMNYALA'] ?> Jam 
			dengan energi minimum pada langganan ini sebesar <b><?php echo number_format(($data_jam['NILAI_JAMNYALA'] * ($data_agenda['DAYA_BARU'] / 1000)))  ?></b> kWh/Bulan.
		</td>
	</tr>
	<tr>
