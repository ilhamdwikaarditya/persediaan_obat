							...
							<td class="wrapper vertical-middle">
								...
								<tr>
									<td class="vertical-middle">
										<a href="index.html">
										<img src="../../assets/admin/layout4/img/epi_rpt.png" style="width:100px;height:40px;" border="0" alt=""/>
										</a>
									</td>
								</tr>
								</table>
			...
			<td>
				...
				<tr>
					<td class="wrapper last">
						...
						<tr>
							<td class="panel" style="font-size:20px;"><center>Informasi tagihan rekening listrik Bulan Februari 2018 ID Customer 8801807, ID Langganan 882010002768</center></td>
						</tr>
						</table>
						<p>Pelanggan Yth. TANGGUH SAMUDERA JAYA, PT</p>
						<p>Di</p>
						<p>JL YOS SUDARSO BLOK A1-7</p>
						<p>&nbsp;</p>
						<p>Dengan hormat,</p>
						...
						<table class="twelve columns" style="margin-bottom: 10px">
						<tr>
							<td class="panel" width="25px">Rekening Bulan</td>
							<td class="panel" width="25px">:</td>
							<td class="panel" width="25px"></td>
							<td class="panel" width="25px"></td>
						</tr>
						<tr>
							<td class="panel">Id Langganan / (ID LANG)</td>
							<td class="panel">:</td>
							<td class="panel"></td>
							<td class="panel"></td>
						</tr>
						<tr>
							<td class="panel">Nama Langganan</td>
							<td class="panel">:</td>
							<td class="panel"></td>
							<td class="panel"></td>
						</tr>
						<tr>
							<td class="panel">Alamat Langganan</td>
							<td class="panel">:</td>
							<td class="panel"></td>
							<td class="panel"></td>
						</tr>
						<tr>
							<td class="panel">Tarif / Daya</td>
							<td class="panel">:</td>
							<td class="panel"></td>
							<td class="panel"></td>
						</tr>
						<tr>
							<td class="panel">Total Tagihan</td>
							<td class="panel">:</td>
							<td class="panel"></td>
							<td class="panel"></td>
						</tr>
						</table>
						<p>Sebagai referensi bagi Bapak/Ibu, Kami juga menyertakan Informasi   Tagihan Listrik dalam bentuk lampiran. Informasi tagihan listrik ini   juga dapat diakses melalui <a href="http://www.ecopowerport.co.id" target="_blank">www.ecopowerport.co.id</a>. <br />
				...
				<tr>
					<td class="wrapper last">
						<table class="twelve columns">
							<tr>
								<td rowspan="9" colspan="3" class="panel"><img src="../../assets/img/fotodepankantorepi.jpg" class="ie10-responsive" style="width:200px;height:150px;"></td>
								<td class="panel" ><p>Informasi lebih lanjut:<br>
