...
<div class="logo">
	<a href="#">
	<img src="<?php echo base_url(); ?>assets/img/obat.png" style="width:200px" alt=""/>
	</a>
</div>
<!-- END LOGO -->
...
<div class="content">
	<!-- BEGIN LOGIN FORM -->
	<form class="login-form" action="<?php echo base_url();?>index.php/welcome/index" method="post">
