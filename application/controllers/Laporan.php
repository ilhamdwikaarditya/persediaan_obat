...
public function rpt_pkdanba(){
	...
	$Rpt .= "<tr>
			...
			<br>
			<table width=100% style='font-size:12px;' border=0 cellspacing=1 cellpadding=1>
			  <tr>
				<td width=20%>&nbsp;</td>
				<td width=20%>&nbsp;</td>
				<td width=20%>&nbsp;</td>
...
if($query_agenda['PAKET_SAR'] == '0' ) //penjabaran kalimat UJL
{
	...
	<tr>
		<td colspan=2 >&nbsp;</td>
		<td align='justify'>
			- UJL baru daya ".number_format($query_agenda['DAYA_BARU'])." VA
		</td>
		<td align='center'>:</td>
		<td >Rp. ".number_format($query_agenda['RP_UJL_BARU'])."</td>
		<td >&nbsp;</td>
	</tr>
	<tr>
		<td colspan=2 >&nbsp;</td>
		...
		<td align='center'>:</td>
		<td >Rp. ".number_format($query_agenda['RP_UJL_TAGIH'])."</td>
		<td >&nbsp;</td>
	</tr>
...
else
{
	...
	<tr>
		...
		<td align='left' valign='top' >b.</td>
		<td colspan=4 align='justify'>
			Uang Jaminan Langganan (UJL) untuk daya ".number_format($query_agenda['DAYA_BARU'])." VA sebesar Rp. 0,- mengingat metode pembayaran telah menggunakan sistem autodebet.
		</td>
	</tr>
	";
}
...
public function rpt_kendalikreditperlang(){
	...
	$q = $this->db->query("select a.thblrek,b.kd_area,b.nama_lang, a.id_lang, b.alamat_lang, '1' lembar, b.no_meter, b.kd_gt, b.tarif, b.daya, a.rptag, a.rp_bk, c.`nama` PROV, d.`nama` KAB, e.`nama` KEC, f.EMAIL1, f.EMAIL2
							...
							where a.id_lang='$id_lang' and a.THBLREK='$thblrek' ");
	$emails = array();
	foreach($q->result() as $r)
	{
		$KD_AREA 	= $r->kd_area;
...
public function rpt_kendalikreditall(){
	set_time_limit('0');
	$cetak		= '1';
		$q = $this->db->query("select a.thblrek,b.kd_area,b.nama_lang, a.id_lang, b.alamat_lang, b.id_cust, a.lembar, b.no_meter, b.kd_gt, b.tarif, b.daya, a.rp_tag, a.rp_bk, b.kec_lang, b.kota_lang, b.prov_lang
						from tp_kendalikredit_a a
						left join dil_listrik_ref b on a.ID_LANG = b.ID_LANG ");
		$Rpt ="";
		foreach($q->result() as $r)
		{
